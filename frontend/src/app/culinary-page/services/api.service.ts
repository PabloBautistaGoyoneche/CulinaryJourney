...
export class ApiService {
    ...
    deleteFavoritesByIdUser(favoriteId: number): Observable<any> {
        ...
        return this.http.delete(`${this.apiUrl}/delete-favorite-recipe?favorite_recipe_id=${favoriteId}`, { headers });
    }
